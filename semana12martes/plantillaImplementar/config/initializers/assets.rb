...
Rails.application.config.assets.paths << Rails.root.join('vendor', 'fonts', 'font-awesome')
Rails.application.config.assets.paths << Rails.root.join('vendor', 'fonts', 'elegant-font')

Rails.application.config.assets.precompile += %w( img/screenshots/admin-1.png )
